...
<head>
    ...
    <title>Archivage resultats etudiants Application </title>
    <!-- icon -->
...
<header>
    ...
    <!-- Navbar -->
    <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar navbar navbar-dark unique-color-dark app-header">
        <div class="container-fluid">

            <!-- Brand -->
            <a class="navbar-brand waves-effect" href="<?php echo base_url() . 'dashboard/index'; ?>">
                <strong>ISS-ARCHIVAGE</strong>
            </a>
                ...
                <ul class="navbar-nav nav-flex-icons">
                    ...
                    <?= $this->session->fullname ?>
                        ...
                        <ul class="dropdown-menu settings-menu dropdown-menu-right">
                            ...
                            <li><a class="dropdown-item" href="<?= base_url('dashboard/logOut'); ?>"><i
    ...
    <aside class="position-fixed unique-color-dark app-sidebar" style="color: white">

      
        <div class="text-center">
            
        <a class="logo-wrapper waves-effect">
            <img src="<?= base_url() ?>resources/img/download_LOGO_ISS.jpg" alt="ISSt"
                 class="img-fluid h-50 w-50 text-center border-rounded" style="border-radius: 50px!important">
        </a>
        </div>
        <div class="list-group list-group-flush ">
            <a href="<?php echo base_url() . 'dashboard/index'; ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'dashboard/index' || uri_string() == 'dashboard/index') ? "active" : "text-dark "; ?>"><i
                        class="fas fa-chart-line"></i> <strong style="color: #ffffff;">Tableau de bord</strong></a>

            <?php if ($this->session->fonction == "administrator") { ?>

            <a href=" <?php echo base_url() . 'admin/agent'; ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'admin/agent') ? "active" : "text-dark"; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Utilisateurs</strong></a>

           <!--

             <a href="<?php echo base_url('admin/classe'); ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'admin/classe') ? "active" : ""; ?>"><i  class="fas fa-bezier-curve"></i> <strong style="color: #ffffff;">Promotions</strong></a>
          

            <a href="<?php echo base_url('admin/option'); ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'admin/agence') ? "active" : "text-dark "; ?>"><i
                        class="fas fa-bezier-curve"></i> <strong style="color: #ffffff;">Options / Filieres</strong></a>
           -->

            <?php } if ($this->session->fonction == "administrator" OR $this->session->fonction == "administratif") { ?>
            
           

            <a href=" <?php echo base_url() . 'administratif/eleve'; ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/eleve') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Registre Etudiants</strong></a>
         
           <a href=" <?php echo base_url() . 'administratif/viewResultat'; ?>"
               class="unique-color list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'administratif/viewResultat') ? "active" : ""; ?>">
                <i class="far fa-address-card"></i> <strong style="color: #ffffff;">Palmares Resultats</strong></a>

   

 <?php } ?>
            <a href="<?php echo base_url('dashboard/logOut'); ?>"
               class="unique-color-dark list-group-item list-group-item-action waves-effect"
