                ...
                <div class="row d-sm-flex justify-content-between">
                    <div class="col-md-6">
                        <h4 class="mb-2 mb-sm-0 pt-1" style="margin-top: 20px;">
                            <span>Liste des options organisées</span>
                        </h4>
                    </div>
                    <div class="col-md-6">
                        <span class="table-add float-right mb-3 mr-2">
                            <a data-toggle="tooltip" data-placement="bottom"
                               ...
                               href="<?php echo base_url() . 'admin/add_form/option/add'; ?>" class="btn btn-primary">
                                <i class="fa fa-plus fa-2x" aria-hidden="true"></i>Creer une nouvelle option</a></span>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="dtMaterialDesignExample" class="table-sm table table-hover table-striped" width="100%">
                        ...
                        foreach ($options as $value): ?>
                            <tr>
                                ...
                                <td class="text-uppercase"><?= $value->section_sid ?></td>
