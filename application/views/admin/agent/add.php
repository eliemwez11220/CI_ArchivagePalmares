            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <form class="" action="<?= base_url() . 'admin/creerCompteAgent' ?>" method="post">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="groupe" class="control-label"><span class="text-danger">*</span>Fonction
                                        </label>
                                        <select class="browser-default custom-select select2" name="groupe">
                                            <option disabled selected>Choisir une fonction utilisateur</option>
