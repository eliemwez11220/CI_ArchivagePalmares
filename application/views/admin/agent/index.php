                    ...
                    <div class="col-md-6">
                        <span class="float-right">
                            <a data-toggle="tooltip" data-placement="bottom"
                               ...
                               href="<?php echo base_url() . 'admin/add_form/agent/add'; ?>" class="btn btn-primary">
                                <i class="fa fa-plus fa-2x" aria-hidden="true"></i>Créer nouveau compte</a></span>
                    </div>
                    ...
                    <table id="dtMaterialDesignExample" class="table-sm table table-hover table-striped" width="100%">
                        ...
                        foreach ($managers as $value) { ?>
                            <tr>
                                ...
                                <td class="text-uppercase"><?= $value->asset_email; ?></td>
                                <td class="text-uppercase"><?= $value->asset_type; ?></td>
                                
                                <td class="text-uppercase"><?= $value->fonction; ?></td>
                                    ...
                                    if ($value->status == 1) { ?>
                                        ...
                                        <span class="table-edit" data-toggle="tooltip" data-placement="bottom"
                                            ...
                                            <button type="button" class="btn-warning btn-rounded btn-sm my-0"><i
                                                        class="fa fa-lock"></i>Bloquer</button></span>
                                        </a>
                                    <?php } else { ?>
                                        ...
                                        <span class="table-edit" data-toggle="tooltip" data-placement="bottom"
                                            ...
                                            <button type="button" class="btn-primary btn-rounded btn-sm my-0"><i
                                                        class="fa fa-unlock"></i>Debloquer</button></span>
                                        </a>
                                    <?php } ?>
                                    <a href="<?= base_url() . "admin/update_form/agent/" . $value->id_asset ?>">
                                        <span class="table-edit" data-toggle="tooltip" data-placement="bottom"
                                            ...
                                            <button type="button" class="btn-success btn-rounded btn-sm my-0"><i
                                                        class="fa fa-edit"></i>Modifier</button></span>
                                    </a>
                                </td>
                            </tr>
                            <?php $line++;
