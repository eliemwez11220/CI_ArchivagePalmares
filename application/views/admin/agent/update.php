                    ...
                    <div class="box-body">
                        ...
                        <form class="" action="<?= base_url(). 'admin/update_agent/agent/'.$agents['id_asset']; ?>" method="post">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="groupe" class="control-label"><span class="text-danger">*</span>Fonction Utilisateur</label>
                                        <select class="browser-default custom-select" name="groupe" >
                                            <?php
                                            if  ($agents['fonction'] == "administrator") { ?>
                                        
                                                <option value="administratif">Administratif - Secretaire</option>
                                                <option selected value="administrator">Administrateur</option>
                                            <?php } elseif ($agents['fonction'] == "administratif") { ?>
                                                
                                                <option selected value="administratif">Administratif - Secretaire</option>
                                                <option selected value="administrator">Administrateur</option>
                                        
                                           
                                            <?php } else { ?>
                                                <option disabled>Choisissez une fonction utilisaeur</option>
                                                <option value="administratif">Administratif - Secretaire</option>
                                                <option selected value="administrator">Administrateur</option>
                                            <?php } ?>
                                        </select>
