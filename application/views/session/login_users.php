...
<head>
    ...
    <title>ArchivagePalmaresa | Login application</title>
    <!-- icon -->
...
style="background-image: url('<?php echo base_url("resources/img/download_LOGO_ISS.jpg");?>');">
...
<div class="login-box">
    ...
    <div class="card border-primary">
        ...
        <h5 class="card-header white-text text-center py-4 bg-danger"
        style="color: #ffffff;">
            Authentification
            <br>
            Archivage Resultats des etudiants
        </h5>
        ...
        <div class="card-body px-lg-5 pt-0">
            ...
            <div class="text-center" style="color: #757575;" action="#!">
                ...
                <form class="" action="<?= base_url(). 'authenticate/login' ?>" method="post">
                    <!-- Email -->
                    <br/>
                    <div class="form-group">
                        <div class="md-form">
                            <input type="text" id="username" name="username" class="form-control"
                            placeholder="Pseudo ou adresse mail"  autofocus>
...
<footer class="page-footer font-small wow fadeIn danger-color-dark fixed-bottom">
    ...
    <div class="pb-4">
        ...
        <div class="footer-copyright py-3 text-light text-center">
            ...
            <a href="https://congoagile.com" target="_blank" class="text-light"> Trecazad Limited</a>
        </div>
        <!--/.Copyright-->
    </div>
    <!-- Social icons -->
