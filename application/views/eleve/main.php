    ...
    <aside class="position-fixed unique-color-dark app-sidebar" style="color: white">
        ...
        <div class="list-group list-group-flush">
            <a href="<?php echo base_url() . 'eleve/index'; ?>"
               class="unique-color-dark text-light list-group-item  <? if ($active = 'active') ?> list-group-item-action waves-effect <?php echo (uri_string() == 'visiteur/index' || uri_string() == 'visiteur/dashboard') ? "active" : ""; ?>"><i
                        class="fa fa-address-card"></i> <strong style="color: #ffffff;">Tableau de bord</strong></a>
            <a href=" <?php echo base_url() . 'eleve/profilEleve'; ?>"
               class="unique-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/profilEleve') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Mon profil</strong></a>

            <a href=" <?php echo base_url() . 'eleve/resultatScolaire'; ?>"
               class="unique-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/resultatScolaire') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Resultats scolaire</strong></a>

            <a href=" <?php echo base_url() . 'eleve/cotationAnnuelle'; ?>"
               class="unique-color-dark text-light list-group-item list-group-item-action waves-effect <?php echo (uri_string() == 'eleve/cotationAnnuelle') ? "active" : ""; ?>">
                <i class="fa fa-user"></i> <strong style="color: #ffffff;">Cotation Cours</strong></a>
            <a href="<?php echo base_url('eleve/logout'); ?>"
               class="unique-color-dark text-light list-group-item list-group-item-action waves-effect"
